...
public class ManagerProductTest {
    ...
    Smartphone smartphone1 = new Smartphone(5, "Айфон", 80_000, "эппл");
    Smartphone smartphone2 = new Smartphone(6, "Гэлакси", 95_000, "Самсунг");
    ...
    public void find2ProductTest() {
        ...
        Product[] actual = manager.searchBy("дж");
    ...
    @Test
    public void findAuthorProducerTest() {
        manager.add(book1);
        manager.add(book2);
        manager.add(smartphone1);

        Product[] actual = manager.searchBy("э");
        Product[] expected = {book1, smartphone1};
